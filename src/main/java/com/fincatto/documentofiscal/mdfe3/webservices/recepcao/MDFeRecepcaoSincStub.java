...
public class MDFeRecepcaoSincStub extends org.apache.axis2.client.Stub {
    ...
    private static synchronized java.lang.String getUniqueSuffix() {
        ...
        if (MDFeRecepcaoSincStub.counter > 99999) {
            MDFeRecepcaoSincStub.counter = 0;
        }
        MDFeRecepcaoSincStub.counter = MDFeRecepcaoSincStub.counter + 1;
        return System.currentTimeMillis() + "_" + MDFeRecepcaoSincStub.counter;
    }

    private void populateAxisService() {
        // creating the Service with a unique name
        this._service = new org.apache.axis2.description.AxisService("MDFeRecepcaoSinc" + MDFeRecepcaoSincStub.getUniqueSuffix());
    ...
    public MDFeRecepcaoSincStub(final org.apache.axis2.context.ConfigurationContext configurationContext, final java.lang.String targetEndpoint, DFConfig config) throws org.apache.axis2.AxisFault {
     ...
     */
    public MDFeRecepcaoSincStub(final org.apache.axis2.context.ConfigurationContext configurationContext, final java.lang.String targetEndpoint, final boolean useSeparateListener, DFConfig config) throws org.apache.axis2.AxisFault {
     ...
     */
    public MDFeRecepcaoSincStub(final java.lang.String targetEndpoint, DFConfig config) throws org.apache.axis2.AxisFault {
    ...
    public com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeRecepcaoSincResult mdfeRecepcaoSinc(final com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeDadosMsg mdfeDadosMsg0) throws java.rmi.RemoteException {
        ...
        try {
            ...
            env = this.toEnvelope(
                ...
                mdfeDadosMsg0, 
                this.optimizeContent(new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoSinc", "mdfeRecepcao")),
                new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcaoSinc", "mdfeRecepcao")
            );
            env.build();
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeRecepcaoSincResult.class, this.getEnvelopeNamespaces(_returnEnv));
            return (com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeRecepcaoSincResult) object;
        } catch (final org.apache.axis2.AxisFault f) {
            final org.apache.axiom.om.OMElement faultElt = f.getDetail();
            if (faultElt != null) {
                if (this.faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "mdfeRecepcao"))) {
                    // make the fault by reflection
                    try {
                        final java.lang.String exceptionClassName = (java.lang.String) this.faultExceptionClassNameMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "mdfeRecepcao"));
                        ...
                        // message class
                        final java.lang.String messageClassName = (java.lang.String) this.faultMessageMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "mdfeRecepcao"));
    ...
    public void startmdfeRecepcao(final com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeDadosMsg mdfeDadosMsg0, final com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincCallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcao/mdfeRecepcao");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        this.addPropertyToOperationClient(_operationClient, org.apache.axis2.description.WSDL2Constants.ATTR_WHTTP_QUERY_PARAMETER_SEPARATOR, "&");
        // create SOAP envelope with that payload
        org.apache.axiom.soap.SOAPEnvelope env;
...
//        this._serviceClient.addHeadersToEnvelope(env);
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = MDFeRecepcaoSincStub.this.fromOM(resultEnv.getBody().getFirstElement(), com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeRecepcaoSincResult.class, MDFeRecepcaoSincStub.this.getEnvelopeNamespaces(resultEnv));
                    callback.receiveResultmdfeRecepcaoSinc((com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeRecepcaoSincResult) object);
            ...
            public void onError(final java.lang.Exception error) {
                if (error instanceof org.apache.axis2.AxisFault) {
                    ...
                    final org.apache.axiom.om.OMElement faultElt = f.getDetail();
                    if (faultElt != null) {
                        if (MDFeRecepcaoSincStub.this.faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "mdfeRecepcao"))) {
                            // make the fault by reflection
                            try {
                                final java.lang.String exceptionClassName = (java.lang.String) MDFeRecepcaoSincStub.this.faultExceptionClassNameMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "mdfeRecepcao"));
                                final java.lang.Class exceptionClass = java.lang.Class.forName(exceptionClassName);
                                final java.lang.reflect.Constructor constructor = exceptionClass.getConstructor(String.class);
                                final java.lang.Exception ex = (java.lang.Exception) constructor.newInstance(f.getMessage());
                                // message class
                                final java.lang.String messageClassName = (java.lang.String) MDFeRecepcaoSincStub.this.faultMessageMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "mdfeRecepcao"));
                                final java.lang.Class messageClass = java.lang.Class.forName(messageClassName);
                                final java.lang.Object messageObject = MDFeRecepcaoSincStub.this.fromOM(faultElt, messageClass, null);
                                final java.lang.reflect.Method m = exceptionClass.getMethod("setFaultMessage", messageClass);
                                m.invoke(ex, messageObject);
    ...
    public static class MdfeDadosMsg implements org.apache.axis2.databinding.ADBBean {
         ...
         * @param param ExtraElement
         */
        public void setExtraElement(final String param) {
            this.localExtraElement = param;
        }
        ...
        public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter, final boolean serializeType) throws javax.xml.stream.XMLStreamException {
            ...
            if (localExtraElement == null) {
                ...
                xmlWriter.writeCharacters(localExtraElement);
            }
    ...
    private org.apache.axiom.om.OMElement toOM(final com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeCabecMsgE param, final boolean optimizeContent) {
        // try {
        return param.getOMElement(com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeCabecMsgE.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        // } catch (org.apache.axis2.databinding.ADBException e) {
        // throw org.apache.axis2.AxisFault.makeFault(e);
        // }
    }

    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
        // try {
        final org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
        // remove o header
        emptyEnvelope.getHeader().discard();
        emptyEnvelope.getBody().addChild(param.getOMElement(com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeDadosMsg.MY_QNAME, factory));
    ...
    private java.lang.Object fromOM(final org.apache.axiom.om.OMElement param, final java.lang.Class type, final java.util.Map extraNamespaces) throws org.apache.axis2.AxisFault {
        try {
            if (com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeDadosMsg.class.equals(type)) {
                return com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeRecepcaoSincResult.class.equals(type)) {
                return com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeRecepcaoSincResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeCabecMsgE.class.equals(type)) {
                return com.fincatto.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
